...
with tab_main:
    ...
    with col_left:
        ...
        st.caption("🏆 빨간과녁: 입지 중심점 | ⚓ 파란/검은핀: 핵심 트래픽 시설 | 🟢🔵🟠🟣: 의료기관 체급별 핀")
        ...
        # [부활] 관내 공급 한의원 체급별 핀 레이어 스크립트 복구 연산
        categories = [
    ...
    with col_right:
        ...
        if saved_report:
            ...
            st.download_button(
                ...
                key="btn_download_report_v11"
            )

# =========================================================================
# [부활] TAB 2: 3개 구역 다중 입지 비교 스펙트럼 덱 전면 기동
# =========================================================================
with tab_compare:
...
# =========================================================================
# [부활] TAB 3: 서울시 전체 랭킹 리스트업 Board 전면 기동
# =========================================================================
with tab_rank:
