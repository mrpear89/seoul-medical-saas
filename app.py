...
seoul_hyper_db = {
    "강남구": {
        "역삼역 오피스 역세권 (테헤란로)": {"상권구분": "초과밀 직장인 대형 오피스 상권", "일반1인": 42, "공동2인": 15, "대형다인": 11, "한방병원": 3, "월평균_추정매출": "5,400만 원", "매출숫자": 5400, "주요_매출_요일": "목요일/월요일", "유동인구": "18.5만 명", "주거인구": "1.2만 명", "상권등급": "S등급", "open_1y": 5, "close_1y": 2, "lat": 37.5006, "lng": 127.0364},
        "대치역 학원가 주거상권": {"상권구분": "고소득층 교육 중심 배후 주거 상권", "일반1인": 28, "공동2인": 6, "대형다인": 2, "한방병원": 0, "월평균_추정매출": "4,100만 원", "매출숫자": 4100, "주요_매출_요일": "토요일/월요일", "유동인구": "4.2만 명", "주거인구": "8.5만 명", "상권등급": "A등급", "open_1y": 2, "close_1y": 1, "lat": 37.4944, "lng": 127.0631},
        "압구정역 뷰티/메디컬 상권": {"상권구분": "국내 최고 수준의 고비급여 특화 상권", "일반1인": 35, "공동2인": 12, "대형다인": 8, "한방병원": 2, "월평균_추정매출": "6,200만 원", "매출숫자": 6200, "주요_매출_요일": "금요일/토요일", "유동인구": "9.5만 명", "주거인구": "2.8만 명", "상권등급": "S-등급", "open_1y": 6, "close_1y": 3, "lat": 37.5262, "lng": 127.0285}
    },
    "서대문구": {
        "신촌역 대학가 메인상권": {"상권구분": "전통 대학가 및 노후 상업지구 상권", "일반1인": 21, "공동2인": 4, "대형다인": 1, "한방병원": 0, "월평균_추정매출": "3,350만 원", "매출숫자": 3350, "주요_매출_요일": "화요일/목요일", "유동인구": "8.5만 명", "주거인구": "2.9만 명", "상권등급": "B등급", "open_1y": 1, "close_1y": 3, "lat": 37.5598, "lng": 126.9368},
        "홍제동 아파트 배후 상권": {"상권구분": "중장년층 밀집 안정형 전통 주거 상권", "일반1인": 16, "공동2인": 2, "대형다인": 1, "한방병원": 1, "월평균_추정매출": "3,100만 원", "매출숫자": 3100, "주요_매출_요일": "월요일/수요일", "유동인구": "2.8만 명", "주거인구": "6.4만 명", "상권등급": "B+등급", "open_1y": 2, "close_1y": 1, "lat": 37.5885, "lng": 126.9442}
    },
    "마포구": {
        "공덕역 오피스 혼합상권": {"상권구분": "마포대로 오피스 및 고소득 아파트 혼합", "일반1인": 29, "공동2인": 6, "대형다인": 3, "한방병원": 1, "월평균_추정매출": "3,950만 원", "매출숫자": 3950, "주요_매출_요일": "수요일/금요일", "유동인구": "11.2만 명", "주거인구": "4.1만 명", "상권등급": "B+등급", "open_1y": 3, "close_1y": 1, "lat": 37.5432, "lng": 126.9515},
        "상암DMC 미디어 오피스상권": {"상권구분": "IT 대기업 집밀 화이트칼라 상권", "일반1인": 15, "공동2인": 4, "대형다인": 2, "한방병원": 0, "월평균_추정매출": "4,150만 원", "매출숫자": 4150, "주요_매출_요일": "화요일/목요일", "유동인구": "7.2만 명", "주거인구": "2.1만 명", "상권등급": "B+등급", "open_1y": 1, "close_1y": 1, "lat": 37.5779, "lng": 126.8916}
    },
    "종로구": {
        "광화문역 오피스 역세권": {"상권구분": "관공서 및 대기업 밀집 오피스 핵심지", "일반1인": 24, "공동2인": 5, "대형다인": 2, "한방병원": 0, "월평균_추정매출": "4,900만 원", "매출숫자": 4900, "주요_매출_요일": "월요일/목요일", "유동인구": "13.5만 명", "주거인구": "0.4만 명", "상권등급": "A등급", "open_1y": 3, "close_1y": 1, "lat": 37.5715, "lng": 126.9768}
    },
    "동대문구": {
        "동대문구 대단지 아파트 밀집 배후지": {"상권구분": "안정적 패밀리형 대단지 주거 상권", "일반1인": 19, "공동2인": 4, "대형다인": 1, "한방병원": 0, "월평균_추정매출": "3,500만 원", "매출숫자": 3500, "주요_매출_요일": "월요일/토요일", "유동인구": "2.9만 명", "주거인구": "7.2만 명", "상권등급": "B+등급", "open_1y": 2, "close_1y": 0, "lat": 37.5744, "lng": 127.0397},
        "청량리역 환승역세권 상권": {"상권구분": "광역 교통망 중심 유동 및 노령인구 밀집 상권", "일반1인": 26, "공동2인": 5, "대형다인": 2, "한방병원": 1, "월평균_추정매출": "3,900만 원", "매출숫자": 3900, "주요_매출_요일": "월요일/수요일", "유동인구": "9.1만 명", "주거인구": "4.2만 명", "상권등급": "A-등급", "open_1y": 3, "close_1y": 1, "lat": 37.5814, "lng": 127.0489}
    }
}
...
for gu, coords in gu_coords.items():
    if gu not in seoul_hyper_db:
        seoul_hyper_db[gu] = {
            f"{gu} 핵심 역세권 메인 상권": {"상권구분": "지역 중심 광역 업무 및 상업 혼합지", "일반1인": 22, "공동2인": 4, "대형다인": 2, "한방병원": 1, "월평균_추정매출": "3,850만 원", "매출숫자": 3850, "주요_매출_요일": "월요일/목요일", "유동인구": "8.2만 명", "주거인구": "3.8만 명", "상권등급": "A-등급", "open_1y": 3, "close_1y": 1, "lat": coords[0], "lng": coords[1]},
...
with tab_main:
    ...
    with col_left:
        ...
        random.seed(total_clinics + int(db["lat"]*100))
        categories = [
    ...
    with col_right:
        ...
        if st.button("✨ 상권 맞춤형 핵심 경영 전략 리포트 즉석 제안", type="primary", use_container_width=True):
            with st.spinner("경영 포지셔닝 수립 중..."):
                ...
                위치: {selected_gu} {selected_zone} | 상권: {db['상권구분']} | 매출: {db['월평균_추정매출']} | 유동인구: {db['유동인구']} | 주거인구: {db['주거인구']}
    ...
    if len(selected_compares) > 0:
        ...
        for idx, cmp_name in enumerate(selected_compares):
            ...
            with cmp_cols[idx]:
                ...
                st.metric(label="⚡ 피크 트래픽 요일", value=c_db["주요_매출_요일"])
                st.metric(label="🩺 관내 한의원 총 공급량", value=f"{c_total}개 소", delta=f"1인 {c_db['일반1인']} / 병원 {c_db['한방병원']}")
                st.markdown("---")
    else:
